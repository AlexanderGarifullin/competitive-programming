...
//    cout << d  << " " << fib[d]<< en;
//
//    cout << fib[n] << ' ' << fib[ d] << ' ' << fib[1+d] << ' ' << fib[2 +d] << en;
    cout << (fib[n] + fib[d] +fib[1+d] + fib[2 +d])% mod << en;
...
//                        per.pb(fib[i] + fib[j] + fib[k] + fib[l]);
//                        map[fib[i] + fib[j] + fib[k] + fib[l]] = {fib[i], fib[j], fib[k],fib[l]};
//                    } else break;
//                }
//            }
//        }
