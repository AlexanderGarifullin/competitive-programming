...
// Васе на группу выдали фиксированное количество билетов в театр. Вася решил посчитать, а сколько вариантов рассадки студентов по местам в театре может быть?

// Формат входных данных
// В единственной строке содержится целое N (0<=N<20) - количество выданных билетов.

// Формат выходных данных
// В единственной строке содержится количество вариантов рассадки студентов по местам в театре.
