...
i32 main() {
  ...
  vvi field1(n,vi(n)), field2(n,vi(n)), field3(n,vi(n)), field4(n,vi(n)) ;

    for (int i = 0; i < n; ++i) {
        string s; cin >> s;
        for (int j = 0; j < isz(s); ++j) {
            field1[i][j] = (s[j] == '1') ? 1 : 0;
        }
    }
    ...
    function<void(vvi , vvi, vvi, vvi)> solve =[&](vvi v1, vvi v2, vvi v3, vvi v4 ) {
    ...
    for (int i = 1; i <= 4; ++i) {
        for (int j = i + 1; j <= 4; ++j) {
            ...
            if (i == 1) v1 = field1;
            else if (i == 2) v1 = field2;
            else if (i == 3) v1 = field3;
            else v1 = field4;

            if (j == 1) v2 = field1;
            else if (j == 2) v2 = field2;
            else if (j == 3) v2 = field3;
            else v2 = field4;

            if (z == 1) v3 = field1;
            else if (z == 2) v3 = field2;
            else if (z == 3) v3 = field3;
            else v3 = field4;

            if (k == 1) v4 = field1;
            else if (k == 2) v4 = field2;
            else if (k == 3) v4 = field3;
            else v4 = field4;
