...
i32 main() {
    ...
    str s1,s2; cin >> s1 >> s2;
    int plus1=0,plus2=0,question=0,minus1=0,minus2=0;
    ...
    if (plus2 > plus1 || minus2 > minus1) cout << 0.0l << en;
    else {
        int needp = plus1 - plus2;
        int needm =  minus1 - minus2;
        if (needp == 0 && needm == 0) cout << 1.0l << en;
        else {
            cout << (ld)perm(question, needp)/ (1<<question)<< en;
        }
    }
}
