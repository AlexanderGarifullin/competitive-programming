        ...
        for (int i = j+1; i < n; ++i) {
            if (s[i] == 'a') {
                ...
                if (cntA > cntB && cntA > cntC) {
                    if (len == -1) len = cntA + cntB + cntC;
                    else len= min(len, cntA + cntB + cntC);
                }
                if (secondA) {
                    if (1 + cntA > cntC + predC && 1 + cntA > cntB + predB) {
                        if (len == -1) len = 1 + cntA + cntB + cntC + predC + predB;
                        else len = min(len,1 + cntA + cntB + cntC + predC + predB);
                    }
                }
                predB = cntB;
                predC = cntC;
