...
i32 main() {
//    freopen("bees.in", "rt", stdin);
//    freopen("bees.out", "wt", stdout);
    ...
    int t_; cin >> t_; while(t_--) {
        ...
        if (x2 <= x1) {
            ...
            vi l1(h+1,-1), r1(h+1,-1), l2(h+1,-1), r2(h+1,-1);
            for (int i = x1; i <= h; ++i) {
                if (i == x1) {
                    l1[i]=r1[i]=y1;
                } else {
            ...
            int leftBorderAlice = l1[ll];
            int rightBorderAlice = r1[ll];
            int leftBorderBob = l2[rr];
            int rightBorderBob = r2[rr];
            if (leftBorderAlice == -1 || leftBorderBob == -1) isdraw = true;
            // A b b A
            else if (leftBorderAlice <= leftBorderBob && rightBorderBob <= rightBorderAlice) {
                if (isAliceMove) {
                    winalice = true;
                } else {
                    int d1 = abs(leftBorderBob - leftBorderAlice);
                    int d2 =  abs(rightBorderAlice - rightBorderBob);
                    if (d1 > 1 || d2 > 1) {
                        isdraw = true;
                    } else {
                        winalice = false;
            ...
            // B a a B
            else if (leftBorderBob <= leftBorderAlice && rightBorderAlice <= rightBorderBob) {
                if (!isAliceMove) {
                    winalice = false;
                } else {
                    int d1 = abs(leftBorderBob - leftBorderAlice);
            ...
            else if (rightBorderBob <= leftBorderAlice || rightBorderAlice <= leftBorderBob) {
                if (rightBorderBob <= leftBorderAlice) {
                    int d = leftBorderAlice - rightBorderBob;
                    if (d > 1) {
                        isdraw = true;
                    } else  {
                        if (isAliceMove) {
                            if (leftBorderBob == rightBorderBob) {
                                winalice = true;
                            } else {
                                if (rightBorderBob == leftBorderAlice && rightBorderBob - leftBorderBob == 1) {
                                    winalice = true;
                                } else {
                                    isdraw = true;
                                }
                            ...
                            if (leftBorderAlice == rightBorderAlice) {
                                winalice = false;
                            } else {
                                if (rightBorderBob == leftBorderAlice && rightBorderAlice - leftBorderAlice == 1) {
                                    winalice = false;
                                } else {
                                    isdraw = true;
                                }
                    ...
                    int d = leftBorderBob - rightBorderAlice;
                    if (d > 1) {
                        isdraw = true;
                    } else  {
                        if (isAliceMove) {
                            if (leftBorderBob == rightBorderBob) {
                                ...
                                if (leftBorderBob == rightBorderAlice && rightBorderBob - leftBorderBob == 1) {
                                    winalice = true;
                                } else {
                                    isdraw = true;
                                }
                            ...
                            if (leftBorderAlice == rightBorderAlice) {
                                ...
                                if (leftBorderBob == rightBorderAlice && rightBorderAlice - leftBorderAlice == 1) {
                                    winalice = false;
                                } else {
                                    isdraw = true;
                                }
            ...
            else  if (leftBorderAlice <= rightBorderBob && leftBorderAlice >= leftBorderBob) {
                int d1 = leftBorderAlice - leftBorderBob;
                int d2 =  rightBorderAlice - rightBorderBob;
                if (isAliceMove) {
                    if (d1 > 1) {
                        isdraw = true;
                    } else {
            ...
            // A B A B
                ...
                int d1 = leftBorderBob - leftBorderAlice;
                int d2 =  rightBorderBob - rightBorderAlice;
                if (isAliceMove) {
                    if (d2 > 1) {
                        isdraw = true;
                    } else {
