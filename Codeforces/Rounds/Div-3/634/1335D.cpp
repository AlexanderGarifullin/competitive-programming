...
i32 main() {
    ...
    ios_base::sync_with_stdio(false);cin.tie(nullptr);cout.tie(nullptr);
     ...
     int t; cin >> t; while(t--) {
        ...
        field[0][0]++;
        if (field[0][0] == 10) field[0][0]=1;

        field[3][1]++;
        if (field[3][1] == 10) field[3][1]=1;

        field[6][2]++;
        if (field[6][2] == 10) field[6][2]=1;

        field[1][3]++;
        if (field[1][3] == 10) field[1][3]=1;

        field[2][6]++;
        if (field[2][6] == 10) field[2][6]=1;

        field[4][4]++;
        if (field[4][4] == 10) field[4][4]=1;

        field[5][8]++;
        if (field[5][8] == 10) field[5][8]=1;

        field[7][7]++;
        if (field[7][7] == 10) field[7][7]=1;

        field[8][5]++;
        if (field[8][5] == 10) field[8][5]=1;
