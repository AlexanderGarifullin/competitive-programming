...
//    freopen("output.txt", "wt", stdout);
    ...
    if (v[0][0] == v[0][1] && v[0][1] == v[0][2]) {
        if (v[0][0] == 'X') win1 = true;
        else if (v[0][0] == '0') win2 = true;
    }
    if (v[1][0] == v[1][1] && v[1][1] == v[1][2]) {
        if (v[1][0] == 'X') win1 = true;
        else if (v[1][0] == '0') win2 = true;
    }
    if (v[2][0] == v[2][1] && v[2][1] == v[2][2]) {
        if (v[2][0] == 'X') win1 = true;
        else if (v[2][0] == '0') win2 = true;
    }
    ...
    if (v[0][2] == v[1][1] && v[1][1] == v[2][0]) {
        if (v[0][2] == 'X') win1 = true;
        else if (v[0][2] == '0') win2 = true;
    }
    ...
    if (v[0][1] == v[1][1] && v[1][1] == v[2][1]) {
        if (v[0][1] == 'X') win1 = true;
        else if (v[0][1] == '0') win2 = true;
    }
