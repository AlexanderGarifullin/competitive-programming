...
i32 main() {
    ...
    int t; cin >> t; while(t--) {
        ...
        if (abs(cntEven - cntOdd) > 1) cmo;
        else {
            ll res1 = 1e18;
            vi v1 = a;
            vi v2 = a;
            set<int> seteven = setEven, setodd = setOdd;
            // odd even odd even
            if (cntEven == cntOdd || cntEven + 1 == cntOdd) {
                res1 = 0;
                for (int i = 0; i < n; ++i) {
                    if (i % 2) {
                        // cur is even
            ...
            setEven = seteven;
            ll res2 = 1e18;
            if (cntEven == cntOdd || cntOdd + 1 == cntEven) {
                res2 = 0;
                for (int i = 0; i < n; ++i) {
                    if (i % 2 == 0) {
                        // cur is even
